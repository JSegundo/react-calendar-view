...
import { BookingWithStationName } from "../../../interfaces"
...
const BookingModal = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      {loading && (
        <div className="bg-slate-300	bg-opacity-50 p-2  text-lg font-bold absolute inset-y-0 right-0 left-0 flex items-center pr-4">
          Loading...
        </div>
      )}
      <ModalItem
